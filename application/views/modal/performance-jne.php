	    ...
	    <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	<div class="form-group" >
					<label class="col-sm-3 control-label no-padding-right" style="padding-top: 6px" for="code">Area Kinerja</label>
					<div class="col-sm-9" >
				...
				<div class="form-group">
	              ...
	              <div class="col-sm-9">
	                <textarea class="form-control" id="DataSource" name="DataSource" placeholder="" rows="4" maxlength="300"></textarea>
	              </div>
	            </div>
	            <div class="form-group">
